...
var PipelineOrchestrator = /** @class */ (function () {
    function PipelineOrchestrator(pipelineApplicationService) {
        this.pipelineApplicationService = pipelineApplicationService;
    }
    PipelineOrchestrator.prototype.execute = function (context, triggerInput) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pipelineApplicationService.runPipeline(context, triggerInput)];
                    case 1: 
